...
Python Syntax Highlighter (from internet)
...
class PythonHighlighter(QSyntaxHighlighter):
    ...
    def __init__(self, parent=None):
        ...
        PythonHighlighter.Rules.append((QRegExp(
                ...
                "number"))
        PythonHighlighter.Rules.append((QRegExp(r"\bPyQt4\b|\bPyQt5\b|\bPyQt6\b|\bQt?[A-Z][a-z]\w+\b"), "pyqt"))
    ...
    def initializeFormats():
        ...
        baseFormat.setFontFamily(CODE_FONT_FAMILY)
        baseFormat.setFontPointSize(CODE_FONT_SIZE)
